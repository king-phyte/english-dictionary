from english_dictionary.api import FreeDictionaryApi
...
class TestFreeDictionaryAPI:
    ...
    @pytest.fixture
    def free_dictionary_api_instance_with_word_king(self, mocker, king):
        instance = mocker.patch("english_dictionary.api.FreeDictionaryApi")
        instance.get_json.return_value = king
        return instance

    @pytest.fixture
    def free_dictionary_api_instance_with_word_hello(self, mocker, hello):
        instance = mocker.patch("english_dictionary.api.FreeDictionaryApi")
